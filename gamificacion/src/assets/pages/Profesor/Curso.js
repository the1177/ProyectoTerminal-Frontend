...
const Profesor = () =>{
    ...
    const [textitprof, onChangeTitProf] = React.useState("Fecha final");
    const [textloc, onChangeLoc] = React.useState("-- : --");
    const [textbio, onChangeBio] = React.useState("-- : --");

    const [texttr, onChangeTr] = React.useState("por ejemplo, sala de conferencia");
    const [textmat, onChangeMat] = React.useState("www.meet.com");
    const [textflex, onChangeFlex] = React.useState("¿En qué consiste el curso?");
